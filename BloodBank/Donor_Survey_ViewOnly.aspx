                    ...
                    <div class="card text-center" style="max-height: 800px; height: 800px; width: 80%;">
                        ...
                        <div class="card-footer text-muted">
                            <div runat="server" id="SurveyGroup" style="display: none;">
                                <asp:Button runat="server" ID="ApproveSurveyBtn" OnClick="ApproveSurveyBtn_Click" CssClass="btn btn-primary  btn-signin" style="background: rgb(119,40,32);" type="reset" Text="Request Approved" UseSubmitBehavior="false" />
                                <asp:Button runat="server" ID="RejectSurveyBtn" OnClick="RejectSurveyBtn_Click" CssClass="btn btn-primary  btn-signin" style="background: rgb(119,40,32);" type="reset" Text="Reject Request" UseSubmitBehavior="false" />
                            </div>
